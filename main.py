...
QUESTIONS = [
    {
        ...
        "options": [
            ...
            "B) Вид мошенничества,целью которого является получение данных пользователя",
    ...
    },
    {
        ...
        "options": [
            ...
            "B)Это второй уровень защиты, требующий потверждения входа в дополнение к паролю.",
    ...
    },
    {
        ...
        "options": [
            ...
            "B) Кража личных данных,публикация оскорбительных постов от имени жертвы",
    ...
    },
    {
        ...
        "options": [
            ...
            "B) К утечке  данных клиентов остановке производства и значительным финансовым потерям",
