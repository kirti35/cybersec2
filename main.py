...
QUESTIONS = [
    {
        ...
        "options": [
            ...
            "B) Вид интернет мошенничества,целью которого является получение конфиденциальных данных пользователя",
            "C) Атака направленнная на отказ в обслуживании сервера"
        ], 
        "correct": 1
    },
    {
    ...
    },
    {
        ...
        "options": [
            ...
            "B)Это второй уровень защиты, требующий потверждения входа в дополнение к паролю.Она нужна для защиты аккаунта даже в случае кражи пароля.",
    ...
    },
    {
        ...
        "options": [
            ...
            "B) Кража личных данных,публикация оскорбительных постов от имени жертвы,репутационный ущерб",
    ...
    },
    {
        ...
        "options": [
            ...
            "B) К утечке коммерческой тайны и персональных данных клиентов остановке производства и значительным финансовым потерям,вплоть до банкротства",
    ...
    },
    {
        ...
        "options": [
            "A) Пароль должен быть коротким,чтобы его легче было запомнить",
            "B) Пароль должен быть сложным и уникальным для каждого приложения",
            "C) Пароль должен содержать дату рождения или имя с фамилией ",
